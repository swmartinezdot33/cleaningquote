...
export default function GHLConfigHelpPage() {
  return (
    <article className="prose prose-slate dark:prose-invert max-w-none">
      ...
      <h2 className="text-lg font-semibold text-foreground mt-8">When to use HighLevel Config</h2>
      ...
      <h2 className="text-lg font-semibold text-foreground mt-8">Create/update contact</h2>
      <p className="text-foreground">
      ...
      <h2 className="text-lg font-semibold text-foreground mt-8">Create note</h2>
      <p className="text-foreground">
      ...
      <h2 className="text-lg font-semibold text-foreground mt-8">Create Quote (custom object)</h2>
      <p className="text-foreground">
      ...
      <h2 className="text-lg font-semibold text-foreground mt-8">Create opportunity</h2>
      <p className="text-foreground">
      ...
      <h2 className="text-lg font-semibold text-foreground mt-8">Default Pipeline and Default Starting Stage</h2>
      <p className="text-foreground">
      ...
      <h2 className="text-lg font-semibold text-foreground mt-8">Use quoted amount for opportunity value</h2>
      <p className="text-foreground">
      ...
      <h2 className="text-lg font-semibold text-foreground mt-8">Opportunity assigned to</h2>
      <p className="text-foreground">
      ...
      <h2 className="text-lg font-semibold text-foreground mt-8">Opportunity tags</h2>
      <p className="text-foreground">
      ...
      <h2 className="text-lg font-semibold text-foreground mt-8">Appointment calendar and Call calendar</h2>
      <p className="text-foreground">
      ...
      <h2 className="text-lg font-semibold text-foreground mt-8">Appointment user and Call user</h2>
      <p className="text-foreground">
      ...
      <h2 className="text-lg font-semibold text-foreground mt-8">Redirect after appointment booking / Appointment redirect URL</h2>
      <p className="text-foreground">
      ...
      <h2 className="text-lg font-semibold text-foreground mt-8">In-service tags and Out-of-service tags</h2>
      <p className="text-foreground">
      ...
      <h2 className="text-lg font-semibold text-foreground mt-8">Appointment booked tags</h2>
      <p className="text-foreground">
      ...
      <h2 className="text-lg font-semibold text-foreground mt-8">Quote completed tags</h2>
      <p className="text-foreground">
