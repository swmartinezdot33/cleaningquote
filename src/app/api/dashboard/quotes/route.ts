...
function mapGHLQuoteToDashboard(record: any): any {
  ...
  return {
    ...
    square_feet: get('square_feet') ?? get('squareFootage') ?? (rawPayload?.squareFeet != null ? String(rawPayload.squareFeet) : null),
    bedrooms: parseNum(get('bedrooms')) ?? parseNum(rawPayload?.bedrooms) ?? null,
