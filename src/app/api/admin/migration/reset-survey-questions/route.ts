...
const CORRECTED_DEFAULT_QUESTIONS: SurveyQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: '8000-10000', label: '8,000 - 10,000 sq ft' },
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'move-in', label: 'Move In Clean', skipToQuestionId: 'fullBaths' },
      { value: 'move-out', label: 'Move Out Clean', skipToQuestionId: 'fullBaths' },
    ],
    required: true,
    order: 6,
  },
